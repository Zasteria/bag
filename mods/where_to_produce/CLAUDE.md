...
Панель зовёт фильтры через `WithFilterTags('building')`, так что галочки видны и
в ванильной панели, и в чужой. **Две копии общей пробы возят оба мода
побайтово одинаковыми**, `check_script.py` за этим следит.
