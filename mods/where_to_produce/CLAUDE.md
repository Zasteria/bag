...
**Шаги 7 и 8 -- чужие окна: галочки плана в списке зданий локации и **одна
отмашка** на галочки автостроя Construction Manager (мод ничего не делает
периодически — это его требование). **Житницу CM план обходит стороной**:
домиков не ставит и мест её не считает, но РГО и выгоду провинции от неё
оставляет. Всё построено, разбор целиком —
[`wtp_integration.md`](../../docs/investigations/wtp_integration.md). Два правила
оттуда, которые дороже прочих: **`root` в фильтре — не сам объект**, и
