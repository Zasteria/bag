...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | **Шаги 0–6 закрыты и видены в игре** тремя прогонами на северной Германии (416 локаций, 1380 зданий на 1380 мест). **Полосы выгоды не решают «сколько»**, товар останавливает **своя квота**, и план ровен настолько, насколько земля позволяет: считая РГО, девятнадцать товаров на **60…65** | **Резервация по стеснённости снята 2026-09-07**: она не сдвинула ничего, а прогон закрыл сам вопрос — план ровен, и мера равномерности `n + rgo` ([`archive/plan_reservation.md`](archive/plan_reservation.md)). **Два котла, город и село; в сельском считаются только свои здания** — товар, у которого в селе одна деревня, в делитель не входит, и в сводке у него прочерк ([`plan_rural_pool.md`](investigations/plan_rural_pool.md)). **Сводка перестроена 2026-09-08 и ждёт прогона**: четыре столбца доли (доля, доля −РГО, доля город, доля село) и прочерки вместо нулей. **Дальше: этот прогон, потом перетасовка внутри провинции и шаги 7 и 8 (Glorp UI и Construction Manager).** **Windows have their own checklist**, [`pitfalls/windows.md`](pitfalls/windows.md); остальные правила — [`archive/wtp_brief_rules.md`](archive/wtp_brief_rules.md) |
