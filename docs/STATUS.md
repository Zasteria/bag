...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | **the plan works and he has seen it** — 192 buildings in 192 rooms, charters 5–6 each. **The editor is a window of its own**: three slots, a cell per good, a changes list beside it | **Steps 1–5 of eight are done and every one has been in the game**; **step 6 — «Расширить», new ground added to a finished plan — is built and has never been loaded**: the old ground is frozen, the new rooms fill to the new share, and a pin the share outgrew lifts by itself. **Step 6 «Расширить» is confirmed in the game** — two runs, «сдвинулось на старой земле 0» both times, and a pin lifted when the share outgrew it. **The live question is his: evenness belongs in output, not in building count** — the probe `_pout<n>` is built and owes one run ([`investigations/plan_share_sides.md`](investigations/plan_share_sides.md)). **Everything the editor holds is the editor's alone: a fresh plan reads none of it**, and **a charter press is a *move* between towns**, bundle and all. **The changes window is a diff and holds no chronology** — the journal goes into `debug.log` at press time — and is shelved at his word. **Windows have their own checklist**, [`pitfalls/windows.md`](pitfalls/windows.md); it cost six builds and three of its rules are in `check_script.py` now. **Two rules of his**: no descriptions in a window header, technical things on the technical tab. Order and rules: [`investigations/wtp_practice_plan.md`](investigations/wtp_practice_plan.md), [`wtp_editor_design.md`](investigations/wtp_editor_design.md) |
