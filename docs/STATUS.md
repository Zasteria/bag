...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | twenty-one loads in: a good or a whole urban right, a window each, live re-ranking, three ages on every row, two «Считать» buttons | the paired two-slot methods, and everything of the twenty-second load |
