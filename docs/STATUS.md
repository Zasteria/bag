...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | four loads in, the whole mechanism confirmed working; a round of refinements untested | tabs, regions, the age filter, one row per province |
