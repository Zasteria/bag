...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | fourteen loads in and doing its job for a single good. Urban rights — a bundle of goods, its own window — are built and never loaded | the rights list and its window, the folded pickers, the age filter |
