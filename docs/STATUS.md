...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | **the plan works and he has seen it** — 192 buildings in 192 rooms, charters 5–6 each. **The editor is a window of its own**: three slots, a cell per good, a changes list beside it. **Steps 1–6 of eight are done and every one has been in the game**, «Расширить» included — two runs, «сдвинулось на старой земле 0» both times | **Three things built 2026-09-07 and none of them ever loaded.** **Раздача уровнями**: a lap raises the level by one and no good takes a second building before every good that can has taken its first, so the gain bands decide *where* and no longer *how many* — the fault it fixes is eight goods with six places each finishing with **one** while cloth with forty-eight finished with **fifteen** ([`plan_as_reservation.md`](investigations/plan_as_reservation.md)). **Окно сводки**: a row a good, its counts, its places, its share, and **why it stopped** — his «мне важно сравнивать». **«Специализация»**: a second plan mode on the mod page, a province's best charter to all its towns and every room to whoever pays most in it, no shares at all ([`plan_specialisation.md`](investigations/plan_specialisation.md)). **What one run must answer is listed in order** in [`NEXT_SESSION.md`](NEXT_SESSION.md). **Windows have their own checklist**, [`pitfalls/windows.md`](pitfalls/windows.md); the rest of the rules are [`archive/wtp_brief_rules.md`](archive/wtp_brief_rules.md) |
