...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | **the plan works, and all eight measured faults in its formula are closed** — [`investigations/plan_gaps.md`](investigations/plan_gaps.md) is the record. The scarce goods now claim their ground before the common ones, every ladder is banded, a charter is gated on its own advance on «Сейчас», and two charters that had been taken from every Scandinavian country are back. «Диагностика» + `mods.bat → 8` reads the report for you | **three of the eight have never been in the game** — one run, «на конец» and «сейчас», closes them; the checklist is the end of `plan_gaps.md` |
