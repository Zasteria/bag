...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | **Единственная версия, и работа идёт в ней.** Его список после партии записан — [`investigations/wtp_backlog.md`](investigations/wtp_backlog.md), девять пунктов и открыт. Построены 1, 2, 3, 5, 8; не построены 4, 6, 7, 9 и ванильная отмашка автостроя. Попытка второй версии закрыта в день начала ([`archive/wtp2_failed.md`](archive/wtp2_failed.md)) | **всё, что построено 2026-09-12, прогона не видело**; и **его слово в тот же день: 90% из того, что документы звали непрогнанным, уже прогонялось или неактуально** — сверять с ним, не с документами |
