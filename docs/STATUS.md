...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | **Шаги 0–6 закрыты и видены в игре** на северной Германии: 416 локаций, 1380 зданий на 1380 мест. **Полосы выгоды не решают «сколько»** — товар останавливает своя квота | **Раздача принята 2026-09-08**: земля 1380 из 1380, обе стороны полные, остаток «−1» измерен ([`archive/wtp_brief_plan_rules.md`](archive/wtp_brief_plan_rules.md)). **«Перетасовать» построена и не прогнана**: кнопка в окне редактора, переезд **между** провинциями, первым проходом меняются местами сами грамоты, домики грамот не трогаются ([`plan_gaps.md`](investigations/plan_gaps.md)). **Шаг 7 видён в игре**: две галочки в списке зданий локации (`gui/filters/`), чужого окна не потребовалось; ступень берётся та, что по зубам. **Шаг 8 построен и не прогнан**: три кнопки (локация, провинция, весь план) одним нажатием переключают галочки автостроя Construction Manager у домиков плана — мод ничего не делает периодически ([`investigations/wtp_integration.md`](investigations/wtp_integration.md)). **Все восемь шагов построены; остался прогон.** **Окна — свой чек-лист**, [`pitfalls/windows.md`](pitfalls/windows.md) |
