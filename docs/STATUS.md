...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | **Шаги 0–6 закрыты и видены в игре** на северной Германии: 416 локаций, 1380 зданий на 1380 мест. **Полосы выгоды не решают «сколько»** — товар останавливает своя квота, и план ровен настолько, насколько земля позволяет | **Раздача принята 2026-09-08**: земля 1380 из 1380, обе стороны полные, остаток «−1» измерен ([`archive/wtp_brief_plan_rules.md`](archive/wtp_brief_plan_rules.md)). **«Перетасовать» построена и не прогнана**: кнопка в окне редактора, переезд **между** провинциями, первым проходом меняются местами сами грамоты, домики грамот не трогаются ([`plan_gaps.md`](investigations/plan_gaps.md)). **Шаг 7 построен и не прогнан**: две галочки в списке зданий локации (`gui/filters/`), чужого окна не потребовалось; проба локации общая с `rgo_bonus_filter`. **Осталось: шаг 8 — Construction Manager.** **Windows have their own checklist**, [`pitfalls/windows.md`](pitfalls/windows.md); остальные правила — [`archive/wtp_brief_rules.md`](archive/wtp_brief_rules.md) |
