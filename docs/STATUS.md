...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | fourteen loads in and doing its job. Urban rights are designed in `investigations/town_rights.md` and wait on one decision | the folded pickers, and the age filter |
