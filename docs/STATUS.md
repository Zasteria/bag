...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | twenty-seven loads in and the per-province answer is trusted: a good or a whole urban right, four ways to frame the ground, three ages on every row | the market picker opened to every market, the button style, one layout question |
