...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | **the plan works and he has seen it**: «города получают права и домики из прав». The tick is the rank now, the charter spam is gone (nine rights over 22 towns, the largest holding three), and **four fifths of placed buildings earn a bonus where they stand, capturing 78% of their recipe's ceiling on average**. «Диагностика» + `mods.bat → 8` reads the report for you | the goods split — nine goods take 45% of the ground, and the lever he had for it is gone with the province ceiling; **the round guard at 50, the twelve passes and the paged plan window, none of the three in game yet** |
