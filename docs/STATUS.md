...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | **Шаги 0–6 закрыты и видены в игре** тремя прогонами на северной Германии (416 локаций, 1380 зданий на 1380 мест). **Полосы выгоды не решают «сколько»**, товар останавливает **своя квота**, и план ровен настолько, насколько земля позволяет: считая РГО, девятнадцать товаров на **60…65** | **Резервация по стеснённости построена и снята 2026-09-07** — она отработала в полную силу и не сдвинула ничего, а прогон закрыл сам вопрос: план ровен, товар останавливает **своя квота**, и мера равномерности — `n + rgo` против неё, а не занятые комнаты ([`SETTLED.md`](SETTLED.md), [`archive/plan_reservation.md`](archive/plan_reservation.md)). **Потолок общего здания построен 2026-09-07 и ждёт прогона**: здание, за которое спорят несколько товаров, встаёт не чаще однотоварного домика ([`plan_villages.md`](investigations/plan_villages.md)). **Дальше: этот прогон, потом перетасовка внутри провинции и шаги 7 и 8 (Glorp UI и Construction Manager).** **Windows have their own checklist**, [`pitfalls/windows.md`](pitfalls/windows.md); остальные правила — [`archive/wtp_brief_rules.md`](archive/wtp_brief_rules.md) |
