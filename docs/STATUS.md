...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | eight loads in, the answer half confirmed and clean in `error.log`; the selection window is now a four-column geography tree, untested | the tree, the map highlight on hover, the 124 gui.log lines |
