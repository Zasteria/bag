...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | seven loads in, the shape is right; three interface faults from the last run fixed and untested | goods icons that never drew, lakes in the rows, a count that drifted |
