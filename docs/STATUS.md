...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | **Шаги 0–6 закрыты и видены в игре** на северной Германии: 416 локаций, 1380 зданий на 1380 мест. **Полосы выгоды не решают «сколько»** — товар останавливает своя квота, и план ровен настолько, насколько земля позволяет | **Два котла, город и село; в сельском считаются только свои здания**; сводка — четыре столбца доли и прочерки вместо нулей. **Раздача принята 2026-09-08**: земля 1380 из 1380, обе стороны полные, 36 товаров из 37 остановила своя квота; остаток «−1» у восемнадцати измерен и это остаток от деления 528 комнат на 35 товаров ([`plan_rural_pool.md`](investigations/plan_rural_pool.md)). **Перетасовка закрыта зондом 2026-09-09 и не построена**: потолок прибавки 2.1 %, из них 86 % заперты в грамотах ([`plan_gaps.md`](investigations/plan_gaps.md)). **Осталось: шаги 7 и 8 — Glorp UI и Construction Manager.** **Дальше: этот прогон, потом перетасовка внутри провинции и шаги 7 и 8 (Glorp UI и Construction Manager).** **Windows have their own checklist**, [`pitfalls/windows.md`](pitfalls/windows.md); остальные правила — [`archive/wtp_brief_rules.md`](archive/wtp_brief_rules.md) |
