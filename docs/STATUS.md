...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | nine loads in; ranking rebuilt around what a method produces, villages scored apart, the Mod Menu table dropped, the tree rebuilt after coming up empty | the two-line row, effective output, the tree's four columns |
