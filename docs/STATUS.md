...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | twenty-two loads in: a good or a whole urban right, a window each, live re-ranking, three ages on every row, two «Считать» buttons | the rights window's two modes, and everything of the twenty-third load |
