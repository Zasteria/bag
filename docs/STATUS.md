...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | twenty-five loads in: a good or a whole urban right, a window each, live re-ranking, three ages on every row, two «Считать» buttons | the recipe filter, the goods column and the buildable tick — everything of the twenty-sixth load |
