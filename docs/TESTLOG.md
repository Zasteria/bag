...
Пятнадцать городских товаров стоят на 17–24 — потолок городской стороны (15)
плюс грамоты, ровно как задумано.

**Разбор теперь считает сам `tools/diag.py`**: три строки в «коротко» —
кого остановила квота, кого потолок города, а кому не хватило земли. Ради них
одних этот прогон стоил своего времени: он же и показал, что вопрос был не
про раздачу.
