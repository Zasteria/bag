...
**2026-09-07, сборка `f9fced` — доля переписана на две стороны. Прогона не
было.**

Его слова: «я уже в отчаянии каком-то… я хочу видеть приблизительно одинаковое
кол-во городских домиков по отношению к друг другу». Построено ровно это: у
товара два счётчика и две квоты, городские домики сравниваются с городскими,
сельские с сельскими. Весов между городом и селом не введено — его вариант с
весами разобран числами и отвергнут: пять товаров с худшей сельской версией
забрали бы всё село целиком.

**Что проверять:** `WTP SHARE` — две дележки; `nt=`/`nr=` в строках товаров;
городская сторона должна выйти почти ровной.
