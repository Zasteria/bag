...
**2026-09-08, пятая сборка — сельский котёл принят, и он же вскрыл две вещи.**
1380 из 1380. Пиво, инструменты, оружие, гончарка, украшения и кожа встали в
`*/0`: сельского счёта у них больше нет, деревни считаются сами
(`forest_village` 70 и `market_village` 70 упёрлись в потолок, `fishing_village`
36).

**Первое, его наблюдение: товары кончают на «доля минус один».** Глина 54 при
доле 55, уголь 64 при 65. Это последний сухой круг: он поднимает долю и на нём
же раздача кончается, так что прибавка не достаётся никому, а в отчёте товар
выглядит недобравшим. Починено — последний сухой круг долю не поднимает.

**Второе, и это регрессия: рыба получила ноль.** `fish 0+21=21`. Рыбацкая
деревня выбирает лучший из своих рецептов, и судовые припасы с гончаркой
перебивают рыбу везде — тридцать шесть деревень встали, ни одна не рыбацкая по
товару. **«Не важно, что производит деревня» в пределе означает «товар может
исчезнуть вовсе»**, и это его решение, а не моё.

**Третье, железо: 8+26 = 34 из 43.** Круг по-прежнему отдаёт его локации
другим, пока подходит его очередь. Построен проход стеснённых: товар, чьей земли
меньше его доли, забирает её **целиком до круга**, по ступеням от самых
стеснённых. Ни уровня, ни доли в этом проходе нет — стеснённому нечего делить.
