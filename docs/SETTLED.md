...
| Is glass unbuildable in Westphalia at the start? | **No — that was a session's wrong inference and the owner's screenshots disproved it.** Both `glass_guild` and `rural_glassmaker` are age 0; they want sand *in the market*, and Münster's and Dülmen's have it. Do not conclude a good is impossible from a `location_potential` without checking the ground. | owner, 2026-09-01 |
