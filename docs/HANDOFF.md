...
генератор и три пробных файла есть. **Перекрытие проверено в игре и работает**:
...
локализацию самой игры: без неё термины вроде advances и levies выбраны на глаз.
