...
обмен внутри провинции не даёт ничего, а числа того зонда вдобавок сравнивали
городскую выгоду с сельской. Разбор —
...
**Дыра, которую прогон и оценит: деревень в обмене нет** — снять деревню нечем.
Зонд печатает их потолок числом `villages=`; велико — значит следующая работа
это обратный эффект и переезд деревень.
