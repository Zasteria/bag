...
не получает ни домика, ни грамоты и её комнаты не идут в счёт мест — но её РГО
считается как раньше, и выгода провинции от неё не меняется. Число печатает
строка `WTP GRANARY`.
...
3. **Автострой.** Открыть локацию рядом с окном плана, нажать иконку со
