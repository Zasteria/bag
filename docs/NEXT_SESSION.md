...
**План закрыт двумя прогонами.** Только городские товары лежат в **15…17**,
умеющие в село — в **50…65**, считая РГО; два прибрежных ниже (39 и 38), потому
что 42 прибрежные локации заняты рыбацкими деревнями на 93 %. Ступень по сторонам
(`_ngt`/`_ngr`) верна по смыслу и на этой земле дала ноль — побережье и без неё
было выбрано. Локация держит по одной деревне каждого из четырёх видов, две
одинаковых — нет; правило было верным изначально.

**Что осталось нерешённым — только его выбор:** перетасовка готового плана
внутри провинции (≈12 тыс. пар против 957 тыс. по всей земле) и резервация по
стеснённости, у которой больше нет измеренного повода.
