...
class AutomationGeneratorTests(unittest.TestCase):
    ...
    def test_cooldown_is_initialized_and_never_read_while_unset(self):
        ...
        start = self.triggers.index("eu5ab_rgo_expansion_allowed = {")
    ...
    def test_rgo_is_deferred_to_strict_feature_order_and_has_independent_quota(self):
        ...
        self.assertIn("rgo_workers >= {", self.triggers)
        self.assertIn("value = max_rgo_workers", self.triggers)
    ...
    def test_diagnostics_and_independent_managers_are_generated(self):
        ...
        self.assertIn("remove_variable = eu5ab_diag_top_locked", self.effects)
        self.assertIn("set_variable = eu5ab_diag_top_locked", self.effects)
        self.assertIn(
